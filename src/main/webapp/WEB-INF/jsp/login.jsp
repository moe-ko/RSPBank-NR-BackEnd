...
<body class="d-flex align-items-center justify-content-center">
    ...
    <div class="card login-form-card col-4 border-0">
        <!-- Card Body -->
        <div class="card-body">
            <!-- Form Header -->
            ...
            <!-- Card Text -->
            <p class="card-text text-black my-2">
                Dont have an account? <span class="ms-2"><a href="/register" class="btn bt-sm text-info">Sign Up</a></span>
            </p>
            <!-- Card Text -->
