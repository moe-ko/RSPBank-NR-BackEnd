...
import com.rspbank.helpers.HTML;
import com.rspbank.helpers.Token;
import com.rspbank.mailMessenger.MailMessenger;
import com.rspbank.models.User;
import com.rspbank.repository.UserRepository;
...
public class RegisterController {
    ...
    public ModelAndView register(@Valid @ModelAttribute("registerUser")User user,
        ...
        MailMessenger.htmlEmailMessenger("no-reply@rspbank.com", email, "Verify Account", emailBody);
